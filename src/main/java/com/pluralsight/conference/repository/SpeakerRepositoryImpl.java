...
//        If you dont need to get the object/id back
//        jdbcTemplate.update("INSERT INTO speaker (NAME) values ( ? )", speaker.getName());

//        One way of getting id back after create
//        KeyHolder keyHolder = new GeneratedKeyHolder();
//        jdbcTemplate.update(new PreparedStatementCreator() {
//            @Override
//            public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
//                PreparedStatement ps = con.prepareStatement("INSERT INTO speaker (NAME) values ( ? )", new String[]{
//                        "id"});
...
//        Using SimpleJdbcInsert to get back the id/object after create
